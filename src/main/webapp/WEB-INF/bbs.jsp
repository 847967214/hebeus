    ...
    <nav class="navbar navbar-default" id="home_nav">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav nav-tabs  nav-pills ">
                ...
                <li role="presentation" class="active"><a href="/page/bbs" target="_self">工程论坛</a></li>
...
<div id="alert" class="hide">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body" id="share_alert_body">
            ...
            <input type="text" class="form-control" id="share_title" placeholder="标题">

            <textarea class="form-control" style="resize:none;margin-top: 12px" rows="4" placeholder="请描述所分享的内容" id="share_info"></textarea>
            ...
            <form style="position: relative">
                ...
                <div>
                    ...
                    <select class="form-control btn-xs"
                            style="width: 140px;margin-left: 8px; display:inline-block;">
                        <option>——请选择学院——</option>
                        <option>矿测学院</option>
                        <option>信电学院</option>
                        <option>文法学院</option>
